import { GoogleGenerativeAI } from 'google-generative-ai'; // Make sure you have the right package installed
...
export async function POST(request) {
  ...
  try {
    ...
    const bucketList = await model.generateResponse(prompt);

    // Send the generated bucket list as response
